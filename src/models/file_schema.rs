...
impl FileSchema {
    pub fn new(id: uuid::Uuid, object: String, bytes: i32, created_at: i32, filename: String, purpose: models::FilePurpose, sample_type: models::SampleType, source: models::Source) -> FileSchema {
        FileSchema {
            id,
            object,
            bytes,
