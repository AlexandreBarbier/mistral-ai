...
pub struct Response {
    ...
    pub integrations: Option<Vec<models::JobOutIntegrationsInner>>,
    #[serde(rename = "trained_tokens", skip_serializing_if = "Option::is_none")]
    ...
    pub metadata: Option<Box<models::JobMetadataOut>>,
    #[serde(rename = "expected_duration_seconds", skip_serializing_if = "Option::is_none")]
    pub expected_duration_seconds: Option<i32>,
    #[serde(rename = "cost", skip_serializing_if = "Option::is_none")]
    pub cost: Option<f64>,
    #[serde(rename = "cost_currency", skip_serializing_if = "Option::is_none")]
    pub cost_currency: Option<String>,
    #[serde(rename = "train_tokens_per_step", skip_serializing_if = "Option::is_none")]
    ...
    pub estimated_start_time: Option<i32>,
...
impl Response {
    pub fn new(id: uuid::Uuid, auto_start: bool, hyperparameters: models::TrainingParameters, model: models::FineTuneableModel, status: Status, job_type: String, created_at: i32, modified_at: i32, training_files: Vec<uuid::Uuid>, details: String) -> Response {
        Response {
            id,
            auto_start,
